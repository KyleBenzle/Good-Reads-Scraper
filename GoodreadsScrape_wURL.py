...
def scrape_url(link):
    ...
    return author_name, book_length, book_image_link, publish_year, published_by, amazon_link, book_genre, url
    ...
    try:
        for row in rows:
            ...
            if link != "":
                ...
                author_name, book_length, book_image_link, publish_year, published_by, amazon_link, book_genre, url = scrape_url(link)
                data[2] = author_name
                data[5] = publish_year
                data[6] = book_length
                data[7] = published_by
