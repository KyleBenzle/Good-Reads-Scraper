...
def scrape_url(link):
    ...
    return author_name, book_length, book_image_link, publish_year, published_by, amazon_link, book_genre, book_price
    ...
    try:
        for row in rows:
            ...
            if link != "":
                ...
                author_name, book_length, book_image_link, publish_year, published_by, amazon_link, book_genre, book_price = scrape_url(link)
                data[2] = author_name
